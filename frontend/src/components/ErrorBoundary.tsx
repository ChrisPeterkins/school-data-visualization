      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="card-surface border-brick-200 bg-brick-50 dark:bg-brick-900/30 p-6">
          ...
          <div className="mt-4 flex gap-2">
            ...
            <button onClick={() => window.location.reload()} className="px-3 py-1.5 text-sm font-medium rounded-lg border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-stone-800">Reload</button>
          </div>
        </div>
      </div>
    );
